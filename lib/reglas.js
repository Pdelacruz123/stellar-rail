...
/** Al pagar escaneando el QR de la tienda, por encima de este monto se pide el PIN. */
export const UMBRAL_PIN = 50;

/**
 * Minutos que vale el codigo de pago del trabajador. Como el codigo de
 * aprobacion de Yape: corto, y sirve para un solo pago.
 */
export const VIGENCIA_CODIGO_MIN = 5;
