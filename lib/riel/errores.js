...
export const CODIGOS = {
  ...
  op_not_authorized: {
    ...
    mensaje: 'Esta tienda no acepta tu vale: no está afiliada a tu empresa.',
    enElLedger: true,
  },
  ...
  op_no_trust: {
    ...
    mensaje: 'Esta tienda todavía no está registrada para recibir vales.',
    enElLedger: true,
  },
  op_underfunded: {
  ...
  op_line_full: {
    ...
    mensaje: 'La tienda alcanzó su límite para recibir vales.',
    enElLedger: true,
  },
  op_low_reserve: {
