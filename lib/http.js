 ...
 *
 * La credencial viaja en una cookie HttpOnly: el codigo de la pagina no la
 * puede leer.
 *
...
/** Quien hace la peticion, o null si nadie entro. */
export async function leerIdentidad(req) {
  const credencial = leerCookies(req)[COOKIE];
